...
const Cards = ({ data, title }) => {
  ...
  return (
    <div className="flex flex-wrap w-ful h-full px-[9%] mt-[3%] bg-[#1F1E24]">
      {data.map((c, i) => (
        <Link
        ...
        >
          ...
          {c.vote_average && (
            <div className="absolute right-[-10%] top-[-5%] rounded-full bg-[#6556CD] text-xl font-semibold text-white w-[5vh] h-[5vh] flex justify-center items-center">
