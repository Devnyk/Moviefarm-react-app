...
const TvDetails = () => {
  ...
  return info ? (
    <div
      ...
      className="relative w-screen h-[190vh] px-[5%]"
    >
      {/* Part 1 navigation */}
      ...
      <div className="w-full flex">
        ...
        <div className="content ml-[5%] text-white">
          {/* heading */}
          <h1 className="text-5xl font-black text-white flex items-end gap-2">
          ...
          <div className="flex items-center text-white text-lg mt-5 mb-10">
            ...
            <h1 className="mr-8">{info.detail.first_air_date}</h1>
            <h1 className="mr-8">
          ...
          {/* translations */}
          <h1 className="text-2xl mt-5 mb-2 font-semibold">
            Tv-Show Translated
          </h1>
      ...
      {/* Part 4 Seasons */}
      <h1 className="text-3xl font-bold text-white mt-8 mb-3">Seasons</h1>
      <div className="w-[100%] flex overflow-x-auto gap-10 p-5 rounded-lg">
        {info.detail.seasons.map((s, i) => (
          <div
            className="relative shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)]"
            key={i}
          >
            <img
              className="min-w-[12vw] h-[35vh] rounded-lg object-cover"
              src={`https://image.tmdb.org/t/p/original/${s.poster_path}`}
              alt=""
            />

            <h1 className="absolute bottom-0 w-full bg-black bg-opacity-50 text-white text-center text-lg font-semibold py-2">
